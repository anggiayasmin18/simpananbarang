...
<body style="background: url(images/inventory.webp) no-repeat; background-size: cover;">
                    ...
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <form action="" method="post">
                                ...
                                <br>
                                <button name="btnLogin" class="au-btn au-btn--block au-btn--blue m-b-20" type="submit">Masuk</button>
                            </form>
                        </div>
                    </div>
                </div>
